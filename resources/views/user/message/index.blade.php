...
<div class="main-content-inner"><br>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <a href="{{route('user.message.create')}}" class="btn btn-rounded mb-3 text-white button-default"><i class="fa fa-plus-circle">&nbsp;</i>Compose</a>
                                ...
                                @endif
                                        ...
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <a href="{{route('user.message.show', $message->id)}}" class="mr-3">
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="editMessage-{{$message->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                     <form action="{{route('user.message.update',$message->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
