...
<head>
  ...
  <link href="img/dost.png" rel="icon">
        ...
        <link rel="stylesheet" href="{{asset('admin/assets/css/introjs.css')}}">
        <script src="{{asset('admin/assets/js/intro.js')}}"></script>
        @stack('css')
        <!-- modernizr css -->
...
@include('layouts.backend.user.partials._header')
    
    @yield('content')

@include('layouts.backend.user.partials._footer')
