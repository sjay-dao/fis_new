    ...
    <div class="row">      
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card border-success mb-3">
                <h5 class="card-header bg-transparent border-default"><i class=" fa fa-refresh">&nbsp;</i> Update User</h5>
                <div class="row">
                        <!-- seo fact area start -->
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card border-success mb-3">
                                <h5 class="card-header bg-transparent border-default"><i class=" fa fa-plus-circle">&nbsp;</i> Add User</h5>
                                <form action="{{route('admin.user.update',$user->id)}}" method="POST" class="form-control" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="card" style="width: 18rem;">
                                                <img src="{{asset('storage/users/'.$user->image)}}" class="card-img-top" alt="Card image cap">
                                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" placeholder="Name Here" class="form-control" value="{{$user->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="adoptor" name="adoptor">
                                                            <option class="0">--Please Sleect Adoptor--</option>
                                                            @foreach ($adoptors as $key=> $adoptor)
                                                                    <option {{ $adoptor->id == $user->adoptor_id ? 'selected' : '' }} value="{{$adoptor->id}}">{{$adoptor->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
