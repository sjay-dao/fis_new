        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card border-success mb-3">
                    <h5 class="card-header bg-transparent border-default"><i class=" fa fa-plus-circle">&nbsp;</i> Add FAQ</h5><br>
                        <form action="{{route('admin.FAQ.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <h6>Question</h6>
                                <input type="text" name="question" placeholder="Question here" class="form-control">
                            </div>
                            <div class="form-group">
                                <h6>Answer</h6>
                                <textarea class="form-control" style="height:30ch" name="answer" placeholder="Answer Here"></textarea>
                            </div>
